...
-- ============================================================
-- esewa_confirm_payment REMOVED
--
-- The esewa-callback Edge Function now does a direct table
-- update to mark payment_sessions as payment_received with
...
-- ============================================================
-- khalti_confirm_payment REMOVED
--
-- The khalti-callback Edge Function now does a direct table
-- update to mark payment_sessions as payment_received with
-- verification_status = 'pending_verification'.
-- Finance/Admin manually verifies via verify_payment() then
-- approves via approve_payment().
