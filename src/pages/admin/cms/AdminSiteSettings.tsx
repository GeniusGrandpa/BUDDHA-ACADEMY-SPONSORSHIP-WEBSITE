        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="grid gap-4">
            ...
            <div>
              ...
              <textarea value={settings?.seo_default_description || ''} onChange={e => setSettings(prev => prev ? { ...prev, seo_default_description: e.target.value } : prev)} rows={3} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
            </div>
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="grid gap-4">
            <div>
              ...
              <textarea value={settings?.footer_description || ''} onChange={e => setSettings(prev => prev ? { ...prev, footer_description: e.target.value } : prev)} rows={3} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
            </div>
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <div className="grid gap-4">
            ...
            <div>
              ...
              <textarea value={settings?.announcement_text || ''} onChange={e => setSettings(prev => prev ? { ...prev, announcement_text: e.target.value } : prev)} rows={2} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Banner Type</label>
              <select value={settings?.announcement_type || 'info'} onChange={e => setSettings(prev => prev ? { ...prev, announcement_type: e.target.value as 'info' | 'warning' | 'success' | 'error' } : prev)} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent">
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          {settings?.maintenance_mode && (
            <div>
              ...
              <textarea value={settings?.maintenance_message || ''} onChange={e => setSettings(prev => prev ? { ...prev, maintenance_message: e.target.value } : prev)} rows={2} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 focus:border-transparent" />
            </div>
          )}
        </section>
      </div>
