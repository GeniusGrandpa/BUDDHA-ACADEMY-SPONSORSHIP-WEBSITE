          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }}
              ...
              <div className="p-4 space-y-4">
                <div>
                  <label htmlFor="news-title" className="block text-sm font-medium text-gray-700 mb-1">Title *</label>
                ...
                <div>
                  <label htmlFor="news-excerpt" className="block text-sm font-medium text-gray-700 mb-1">Excerpt</label>
                  <textarea id="news-excerpt" value={form.excerpt} onChange={e => setForm({ ...form, excerpt: e.target.value })}
                    rows={2}
                ...
                <div>
                  ...
                  <textarea id="news-content" value={form.content} onChange={e => setForm({ ...form, content: e.target.value })}
                    rows={8}
                ...
                <div>
                  <label htmlFor="news-image" className="block text-sm font-medium text-gray-700 mb-1">Featured Image URL</label>
