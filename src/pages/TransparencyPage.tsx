    ...
    <div>
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 sm:mb-16">
              {content?.allocation_title && <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">{content.allocation_title}</h2>}
              {content?.allocation_description && <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">{content.allocation_description}</p>}
            </div>
                  ...
                  <div key={idx} className="bg-gray-50 rounded-xl p-4 sm:p-6">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-sm sm:text-base font-semibold text-gray-900">{item.label}</h3>
                      </div>
      ...
      {verificationSteps.length > 0 && (
        <section className="py-12 sm:py-16 lg:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10 sm:mb-16">
              {content?.verification_title && <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">{content.verification_title}</h2>}
              {content?.verification_description && <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">{content.verification_description}</p>}
            </div>
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
              {content?.impact_report_title && <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">{content.impact_report_title}</h2>}
              <div className="bg-gray-50 rounded-xl p-6 sm:p-8">
                <p className="text-gray-600 text-sm sm:text-base mb-4">{t('transparency_report_heading')}</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-24">
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-8">
          {content?.receipt_policy_text && (
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8">
              {content.receipt_policy_title && <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">{content.receipt_policy_title}</h3>}
              <p className="text-gray-600 text-xs sm:text-sm">{content.receipt_policy_text}</p>
            </div>
          )}
          {content?.donor_privacy_text && (
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8">
              {content.donor_privacy_title && <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">{content.donor_privacy_title}</h3>}
              <p className="text-gray-600 text-xs sm:text-sm">{content.donor_privacy_text}</p>
            </div>
          )}
        </div>
      </div>
