  ...
  return (
    <div>
      <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-amber-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4 sm:mb-6">{data.title}</h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">{data.description}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">How Your Donations Are Used</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
            <div className="relative w-64 h-64 mx-auto lg:mx-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center flex-col">
                ...
                <span className="text-sm text-gray-500">to Programs</span>
              </div>
            </div>
              ...
              {data.allocationData.map((item, idx) => (
                <div key={idx} className="bg-gray-50 rounded-xl p-4 sm:p-6">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm mt-2">
                    {ALLOCATION_DESCRIPTIONS[item.name] || `Funds allocated to ${item.name}`}
                  </p>
                </div>
              ))}
            </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Student Verification Process</h2>
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Annual Impact Report</h2>
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8 border border-amber-100">
              <p className="text-gray-600 text-sm sm:text-base mb-4 font-medium">We publish detailed annual reports showing:</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 lg:pb-24">
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-8">
          <motion.div
            ...
            <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">{RECEIPT_POLICY}</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            ...
            <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">{DONOR_PRIVACY}</p>
          </motion.div>
        </div>
      </div>
    </div>
