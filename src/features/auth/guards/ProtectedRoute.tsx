  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-50">
      <div className="text-center max-w-md px-4">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-2"><Tr text="Access Revoked" /></h1>
        <p className="text-gray-600 mb-2">
          <Tr text="Your session has been terminated because your account does not have permission for this area." />
        </p>
        <p className="text-gray-500 text-sm"><Tr text="Redirecting to login..." /></p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-orange-50">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-600 text-sm"><Tr text="Verifying access..." /></p>
        </div>
      </div>
    )
  }
