      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
          <div className="max-w-lg w-full text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4"><Tr text="Something went wrong" /></h1>
            <p className="text-gray-600 mb-8">
              <Tr text="An unexpected error occurred. Please try again or contact support if the problem persists." />
            </p>
