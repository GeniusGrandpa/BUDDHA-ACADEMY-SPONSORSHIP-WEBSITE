...
const trustIndicators = [
  { label: 'Verified NGO', description: 'Registered nonprofit organization' },
  { label: 'Transparent Fund Usage', description: '100% accountability reporting' },
  { label: 'Secure Donations', description: 'Encrypted & verified transactions' },
]
        ...
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 text-white/80 text-sm font-light tracking-wide mb-6">
              ...
              Buddha Academy Sponsorship Program
            </span>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-light text-white leading-tight tracking-tight mb-6">
              Every Contribution
              <br />
              <span className="font-medium text-[#fde68a]">Creates Opportunity</span>
            </h1>

            <p className="text-lg sm:text-xl text-white/90 font-light leading-relaxed max-w-2xl mb-10">
              In rural Nepal, access to quality education remains a distant dream for many children.
              Your sponsorship bridges the gap between potential and opportunity, providing meals,
              materials, and mentorship to students who need it most.
            </p>
          </motion.div>
